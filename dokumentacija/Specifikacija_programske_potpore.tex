\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik na početnoj stranici odabire opciju "Registracija".
							\item Sustav otvara ekran registracije.
							\item Korisnik unosi svoj OIB te željenu lozinku
							\item Korisnik potvrđuje unos podataka odabirom akcije "registracija".
						...
						\item[] \begin{packed_item}
							...
							\item[] \begin{packed_enum}
								...
								\item Sustav obaviještava korisnika da je došlo do greške te ostaje na stranici registracije (ne briše unesene podatke).
							\end{packed_enum}
							
							\item[5.b] Odabir OIB-a za koji je zabilježeno da se osoba već registrirala u sustav
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik na početnoj stranici odabire opciju "Prijava".
							\item Sustav otvara ekran prijave.
							\item Korisnik unosi svoj OIB te odgovarajuću lozinku.
							\item Korisnik odabere opciju "prijava".
						...
						\item[] \begin{packed_item}
							...
							\item[] \begin{packed_enum}
								...
								\item Sustav obaviještava korisnika da je došlo do greške te ostaje na stranici prijave (ne briše unesene podatke).
							\end{packed_enum}
							
							\item[5.b] Sustav provjerava podatke i utvrđuje da je uneseni par OIB - lozinka netočan.
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Roditelj stisne na ikonu profila.
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Roditelj na početnoj stranici odabere profil čije osobne podatke želi mijenjati (svoj ili djetetov).
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Roditelj na stranici bira opciju "Naruči".
						...
						\item[] \begin{packed_item}
							...
							\item[6.a] Roditelj učita nalaz ali odabere opciju "Zatvori".
							\item[] \begin{packed_enum}
								
								\item Nalaz se neće poslati i sustav će vratit roditelja na pregled poruka na profilu.
							\end{packed_enum}
							
							\item[6.b] Roditelj nije prijavljen ni kod jednog liječnika ili dijete nije prijavljeno ni kod jednog pedijatra.
							\item[] \begin{packed_enum}
								
								\item Roditelju neće biti omogućena opcija "Pošalji".
							\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[] \begin{packed_enum}
								...
								\item Sustav umjesto karte prikazuje poruku pogreške.
							\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Sustav roditelju vraća pregled poruke - roditelj može vidjeti poruku liječnika te informaciju da je odgovarajući mail poslan poslodavcu.
						\end{packed_enum}
						...
						\item[] \begin{packed_item}
							...
							\item[] \begin{packed_enum}
								...
								\item Unutar obavijesti neće biti naznačeno da je mail poslan poslodavcu.
							\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[3.a] Roditelj nije unio mail adresu vrtića/škole na profilu djeteta.
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[7.a] Roditelj odabere opciju "Zatvori".
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC13 - Prijavi novo dijete kod pedijatra}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Pedijatar na početnoj stranici bira opciju "Dodaj pacijenta".
							\item Sustav pedijatru vraća popis djece koja još nisu prijavljena kod nekog pedijatra.
							\item Pedijatar u popisu neprijavljene djece pronalazi dijete koje želi prijaviti kod sebe, stisne na njega te odabere opciju "Upiši".
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Pedijatar bira opciju "Nova poruka".
							\item Sustav pedijatru vraća prozor u kojem pedijatar može unijeti podatke o pregledu.
							\item Pedijatar bira kao naslov poruke "Dijagnoza", opiše pregled i dijagnozu te opcionalno može odabrati šalje li se ispričnica i preporuka za bolovanje roditelja.
						...
						\item[] \begin{packed_item}
							...
							\item[6.a] Pedijatar bira opciju "Zatvori".
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Pedijatar bira naslov "Dijagnoza", opiše razlog izdavanja preporuke te bira opciju "Bolovanje roditelja" i opciju "Ispričnica".
							\item Pedijatar bira opciju "Pošalji".
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Pedijatar bira kao naslov "Nalaz iz laboratorija", opiše nalaz, može priložiti dokument biranjem opcije "Prilog" te opcionalno može odabrati šalje li se ispričnica i preporuka za bolovanje roditelja.
							\item Pedijatar bira opciju "Pošalji".
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Sustav pedijatru vraća pregled poruka s profilom djeteta.
							\item Pedijatar bira jednu od poruka koje je primio od roditelja.
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[7.a] Pedijatar odabere opciju "Zatvori".
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Sustav pedijatru vraća pregled poruka s profilom djeteta.
							\item Pedijatar odabere opciju "Nova poruka".
							\item Sustav pedijatru vraća prozor u kojem pedijatar bira vrstu pregleda te može utipkati napomenu.
							\item Pedijatar kao naslov poruke odabere "Specijalistički pregled", odabere vrstu bolesti te dodaje napomenu ako to želi.
							\item Pedijatar odabere opciju "Pošalji".
							\item Sustav šalje poruku roditelju i pedijatra vraća na pregled poruka s profilom djeteta.
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Liiečnik na početnoj stranici bira opciju "Dodaj pacijenta".
							\item Sustav liječniku vraća popis roditelja koji još nisu prijavljeni kod nekog liječnika.
							\item Liječnik u popisu neprijavljenih roditelja pronalazi osobu koje želi prijaviti kod sebe, stisne na nju i odabere opciju "Upiši".
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Liječnik bira opciju "Nova poruka".
							\item Sustav liječniku vraća prozor u kojem liječnik može upisati podatke o pregledu.
							\item Liječnik kao naslov bira "Dijagnoza", opiše pregled i dijagnozu te opcionalno može odabrati izdaje li se bolovanje za roditelja.
						...
						\item[] \begin{packed_item}
							...
							\item[6.a] Liječnik bira opciju "Zatvori".
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Liječnik u novootvorenom prozoru bira opciju "Odobri bolovanje".
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Liječnik kao naslov bira "Dijagnoza", opiše razlog propisivanja bolovanja te bira opciju "Bolovanje roditelja".
							\item Liječnik bira opciju "Pošalji".
						...
						\item[] \begin{packed_item}
							...
							\item[6.a] Liječnik odabere opciju "Zatvori".
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Liječnik bira kao naslov "Nalaz iz laboratorija", opiše nalaz, može priložiti dokument biranjem opcije "Prilog" te opcionalno može odabrati i opciju za izdavanje bolovanja.
							\item Liječnik bira opciju "Pošalji".
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Sustav liječniku vraća pregled poruka s profilom roditelja.
							\item Liječnik bira jednu od poruka koju je poslao roditelj.
							\item Sustav liječniku vraća pregled poruke.
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Liječnik odabere opciju "Nova poruka".
							\item Sustav liječniku vraća prozor u kojem liječnik može odabrati vrstu bolesti te dodati napomenu.
							\item Liječnik kao naslov bira "Specijalistički pregled", odabere vrstu bolesti te dodaje napomenu ako to želi.
							\item Liječnik odabere opciju "Pošalji".
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator odabere opciju "Spremi".
							\item Baza podataka se ažurira.
			...
			\subsection{Sekvencijski dijagrami}
					...
					\textbf{Obrazac uporabe UC6 - Učitaj nalaz u sustav, UC14 - Upiši podatke o pregledu djeteta obavljenom kod pedijatra i dijagnoza, UC15 - Izdaj preporuku za bolovanje za roditelja bolesnog djeteta, UC16 - Pošalji nalaz iz laboratorija djeteta, UC17 - Pregledaj učitane nalaze djeteta od strane roditelja, UC23 - Odobri preporuku za bolovanje za roditelja bolesnog djeteta}\\
				...
				\textbf{Obrazac uporabe UC30.1 - Prijavi novog roditelja u sustav, UC30.2 - Prijavi novo dijete u sustav}\\
				...
				\textbf{Obrazac uporabe UC5 - Promjeni osobne podatke}\\
				...
				\eject
					...
					\textbf{Obrazac uporabe UC13 - Prijavi novo dijete kod pedijatra, UC21 - Prijavi novog roditelja kod liječnika}\\
