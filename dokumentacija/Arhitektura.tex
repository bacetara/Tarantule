\chapter{Arhitektura i dizajn sustava}
	...
	\end{itemize}
		...
		\end{figure}
		 ...
		 \underbar{\textit{Frontend poslužitelj}} je poslužitelj koji komunicira s web preglednikom klijenta preko HTTP (\textit{(engl. Hyper Text Transfer Protocol}) protokola. Na frontend poslužitelju se nalazi frontend dio web aplikacije kojem frontend poslužitelj prosljeđuje dolazne zahtjeve. Ovaj poslužitelj komunicira i s backend poslužiteljem.
