\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\begin{figure}[H]
			\includegraphics[width=\textwidth]{slike/graf1.png} %veličina u odnosu na širinu linije
			\caption{Dijagram pregleda promjena 1}
			\label{fig:dijagrampregpr1} %label mora biti drugaciji za svaku sliku
		\end{figure}
		
		\begin{figure}[H]
			\includegraphics[width=\textwidth]{slike/graf2.png} %veličina u odnosu na širinu linije
